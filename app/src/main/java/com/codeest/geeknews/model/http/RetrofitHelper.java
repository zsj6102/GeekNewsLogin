...
public class RetrofitHelper implements HttpHelper {
    ...
    @Override
    public Flowable<WelcomeBean> fetchWelcomeInfo(String url,String c,String a,String phone,String pwd) {
        return mZhihuApiService.getWelcomeInfo(url,c,a,phone,pwd);
    }
